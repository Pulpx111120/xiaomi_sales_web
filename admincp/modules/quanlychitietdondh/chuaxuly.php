<?php
	...
	and D.TrangThai='false'
	ORDER BY C.GiaDatHang ASC";
	$run=mysqli_query($conn, $sql);
?>

<div class="quanlychitietdondh">
<p class="title1"><span class="title2">Quản lý chi tiết đơn đặt hàng</span><span class="title3">/</span>Danh sách chi tiết đơn đặt hàng chưa xử lý</p>
