<?php
	$sql="SELECT * FROM dathang WHERE TrangThai='true' ORDER BY NgayDH ASC";
	$run=mysqli_query($conn, $sql);
?>

<div class="quanlydondathang">
<p class="title1"><span class="title2">Quản lý đơn đặt hàng</span><span class="title3">/</span>Danh sách đơn đặt hàng đã xử lý</p>
